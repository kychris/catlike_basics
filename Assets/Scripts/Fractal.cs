...
public class Fractal : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Fractal childD = CreateChild(Vector3.forward, Quaternion.Euler(90f, 0f, 0f)); //forwards
        Fractal childE = CreateChild(Vector3.back, Quaternion.Euler(-90f, 0f, 0f)); //backwards
